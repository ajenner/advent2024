...
public class Runner {
    ...
    static String[] sampleAnswers1 = new String[]        {"11", "2", "161", "18", "143", "41", "3749", "14"};
    static String[] sampleAnswers2 = new String[]        {"31", "4", "48" , "9",  "123", "6", "11387", "34"};
    static boolean[] hasDifferentSamples = new boolean[] {false, false, true, false, false, false, false, false};

    public static void main(String[] args) throws Exception {
        String[] days = new String[] {"01", "02", "03", "04", "05", "06", "07", "08"};
